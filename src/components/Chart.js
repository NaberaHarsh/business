...
export default function Chart() {
  ...
  useEffect(() => {
    axios
      .get(
        "http://localhost:3000/count-grouped-component"
      )
      .then(({ data }) => {
  ...
  return (
    ...
    width="100%" 
    height="300px" 
    data={isDense ? countLog :  counts}
    options={{
      title:
        'Counts of error occured per component ( Yesterday )',
      hAxis: { title: 'Component Name' },
      vAxis: { title: 'Counts' },
